...
public enum ErrorCode {
    ...
    MSSV_NOT_EXISTED(1016, "User with this MSSV not existed", HttpStatus.NOT_FOUND),
    TICKET_NOT_EXISTED(1015, "Ticket not existed", HttpStatus.NOT_FOUND),
    ...
    EMAIL_SENDING_FAILED(1017 , "Failed to send reset email", HttpStatus.INTERNAL_SERVER_ERROR),
    ;
